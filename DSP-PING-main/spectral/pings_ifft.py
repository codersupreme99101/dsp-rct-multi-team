...
f_c = 172000000 # Hz
f_t_arr = np.array([15000])#, 25000])#np.array([50, 2550, 5050, 7550, 10050, 12550, 15050, 17550, 20050, 22550, 25050, 27550, 30050, 32550, 35050]) # Hz offset from center to guess
t_ping = 0.05 # s
ping_period = 1 # s
ping_power = -96 # dB
noise_power = -60 # dB
...
#print(cfo_alpha_off(x, 64)) #trials 
#print(cfo_alpha_off(x, 16))
